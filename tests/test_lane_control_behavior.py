...
class LaneControlBehaviorTests(unittest.TestCase):
    ...
    def test_single_lane_lateral_scale_and_damping_wiring(self):
        ...
        control_geometry = (ROOT / "src/ctrl/control_geometry.cpp").read_text(
            encoding="utf-8")
        self.assertIn("lateralApplied", motion)
        self.assertIn("params->ctrl.laneLateralScale", motion)
        self.assertIn("weakHybridConflictLateralScale", motion)
        self.assertIn("params->ctrl.laneRecoveryMode", motion)
        self.assertIn("params->ctrl.laneNearError", motion)
        self.assertIn("singleLaneLateralScale(", center)
        self.assertIn("laneLateralScaleReason", center)
        self.assertIn("params->ctrl.laneRecoveryMode =", center)
        self.assertIn("params->ctrl.laneNearError =", center)
        self.assertIn("recoveryDampingEnabledForMode(recoveryMode)", center)
        self.assertIn("singleLaneLateralScale", builder)
        self.assertIn("weakHybridConflictLateralScale", builder)
        self.assertIn("WEAK_HYBRID_CONFLICT", builder)
        ...
        self.assertIn("left_clipped", telemetry)
        self.assertIn("right_clipped", telemetry)
        self.assertIn("left_longest_border_run", telemetry)
